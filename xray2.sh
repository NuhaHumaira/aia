...
END
wget -q -O /etc/nginx/conf.d/grpc.conf https://raw.githubusercontent.com/erwinproject/dansavpn/main/config/grpc.conf
systemctl restart nginx
...
cd /usr/bin
GITHUB=raw.githubusercontent.com/erwinproject/dansavpn/main
